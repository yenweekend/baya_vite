...
const productDetail = {
  ...
  name: "lorem20 ProductItemStyled",
};
const ProductItem = ({ tagSale = null }) => {
  ...
  return (
    <>
      <ProductItemStyled className={` w-full product shrink-0 bg-[#fff]`}>
        <div className="product-item-thumb w-full overflow-hidden relative cursor-pointer group/image">
          <div
            className=" w-full h-full overflow-hidden relative group/image p-[5px]  "
            onClick={() => {
              navigate(`/product/${productDetail.slug}`);
            }}
          >
          ...
          <button
            onClick={showModal}
            className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] font-bold opacity-0 invisible group-hover/image:opacity-[1] group-hover/image:visible  w-[34px] h-[34px] bg-[#fff] rounded-full flex items-center justify-center view-quick text-[#5d5d5d] transition-all ease-linear duration-150 hover:text-[#fff] hover:bg-[--primary-bg]"
          >
              ...
              <div className="flex_41 pr-[12px]">
                <Carousel arrows infinite={false}>
                  {productDetail["Images"].map((img, idx) => (
                    <div
                      className="product_img pb-[100%] overflow-hidden relative"
                      key={idx}
                    >
              ...
              <div className="flex_58 px-[12px] ">
                <div className="product_info">
                  <div className="">
                    <Link
                      to={`/brand/abc}`}
                      className="brand_name uppercase no-underline text-[rgb(176,16,15)] font-bold"
                    >
                        ...
                        <div className=" flex_1 px-[8px] flex items-center">
                          ...
                          <div className="flex_1">
                            <div className="font-semibold">
                              Kem Dưỡng AHC Làm Sáng Vùng Da Mắt Luminous Glow
                              Real Eye Cream For Face 30Ml
                            </div>
        ...
        <div className=" rounded-b-lg px-[14px] pb-[10px]">
          <div className="brand_text uppercase text-center pt-[5px]">
            <span>{productDetail["Brand"]["name"]}</span>
          </div>
          <div className="items_desc text-center">{productDetail.name}</div>
          ...
          <div className="stock h-4 w-full rounded-full bg-[rgba(199,49,48,0.314)] relative overflow-hidden">
            <div
              className={`absolute h-[16px] stock-bar left-0  w-[20%]  whitespace-nowrap flex items-center `}
            >
              <span className="pl-2 text-white text-[10px]">
                còn 13 sản phẩm
              </span>
            </div>
          </div>
