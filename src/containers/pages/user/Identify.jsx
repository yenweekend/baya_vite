    ...
    <div className="min-h-screen flex flex-col items-center justify-center ">
      <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_0_10px_-3px_rgba(6,81,237,0.3)] rounded-md ">
        <div className="md:max-w-md w-full px-4 py-4">
          <form>
            <div className="mb-12">
              <h3 className="text-gray-800 text-3xl font-extrabold">Xác thực email người dùng </h3>
            ...
            <div>
              <label className="text-gray-800  block mb-2 text-[20px]">Email đã đăng ký </label>
            ...
            <button className=" w-fit text-white submit_btn px-4 py-2 rounded-lg bg-blue-600" type='button'>
                Xác nhận
            </button>
