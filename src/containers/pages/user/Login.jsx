...
import assignAccessToken from '../../../api/assignAcessToken';
            ...
            <form>
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="email" type="text" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" autoComplete='off' onChange={handleChange}/>
              ...
              <div class="mt-8">
                ...
                <div class="relative flex items-center">
                  <input name="password"  type={isPasswordVisible ? 'text' : 'password'} required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" autoComplete='off' onChange={handleChange} />
              ...
              <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <div>
                  <a href="/login/identify" class="text-blue-600 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              ...
              <div class="mt-12">
                <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" onClick={handleLogin}>
                  Đăng nhập
                </button>
              </div>
