  ...
  />
        ...
        <div className='sheets mt-3  border border-solid rounded-[6px]'>
            <div className='flex items-center bg-[#ebebeb] py-2 px-3'>
                ...
                <div className='whitespace-nowrap uppercase font-bold  flex-none w-[15%]'>Số lượng</div>
                <div className='whitespace-nowrap uppercase font-bold  flex-none w-[10%]'>Giá</div>
                <div className='whitespace-nowrap uppercase font-bold   flex-none w-[10%]'>Đã bán</div>
                <div className='whitespace-nowrap uppercase font-bold  media-content'>Loại sản phẩm</div>
            </div>
            <div className='flex items-center  py-4 px-3 product'>
                ...
                <div className='whitespace-nowrap  font-bold   flex-none w-[10%]'>0</div>
...
.stock{
    background-color: rgba(43, 195, 141, 0.2);
}
